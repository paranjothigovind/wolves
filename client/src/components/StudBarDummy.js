...
export default function CustomizedTabs() {
  ...
  const [ numUse, setNumUse ] = React.useState(false);

  const onSubmit = () => {
    const user =  Num;
    console.log(user);
      axios.get('https://vts-1.herokuapp.com/login?phonenumber=918682893336&channel=sms')
      .then(response => {
  ...
  // useEffect(function onSubmitOTP(){
  //   const user =  Num;
  //   // const OTP =  OTP;
  //   console.log(OTP);

  //   axios.get('http://localhost:5000/verify?phonenumber=91'+user+'&code='+ OTP)
  //   .then(response => {
  //       console.log(response.data.message)
  //       if (response.data.length > 0) {
  ...
  //   const user =  Num;
  //   console.log(user);
  //     axios.get('http://localhost:5000/login?phonenumber=918682893336&channel=sms')
  //     .then(response => {
  //       if (response.data.length > 0) {
  //         console.log(response.data.message)
  //       }    
              ...
              <div className={Style.drawerContainer}>
                ...
                
                {
                    ...
                    <div>
                        ...
                        <TextField  id="  outlined-standard-full-width" 
...

                {
                 ...
                 <div>  
                    ...
                    <div className="row space-between">
                      <div className="col-6">
                        <button
                          ...
                          onClick={()=> setVMobileNum(false) || setOtp(false) || setStudOrTutor(true) && this.onSubmitOTP }
                          >Login</button>
                      </div>
                    ...
                    {
                      OTPStatus === "VERIFIED" ? <div> <p> OTP verified </p> </div> :   <div> <p> OTP NOT verified </p> </div>
                    }
